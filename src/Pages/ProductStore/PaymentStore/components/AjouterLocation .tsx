...
<TextField
  ...
  value={postal}
    ...
    <Button onClick={handleClose} variant='outlined' sx={{color:'black',bgcolor:'Window',borderRadius:'12px',fontWeight:'100',borderColor:'#9e9e9e' ,":hover":{color:'black',borderColor:'#9e9e9e',bgcolor:'Window'} }} >
        Annuler
    </Button>
      </Box>
            </Box>
