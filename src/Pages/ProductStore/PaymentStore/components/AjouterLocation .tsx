...
export const AjouterLocation = ({addLocation,setAddLocation}:any) => {

    const handleClose = () => setAddLocation(false);
    ...
    const handelCreateLocation = async()=>{
      try{
          const response = await fetch(`http://localhost:8000/createlocationuser `,{
            method:'POST',
            credentials:"include", 
            headers: {
...
<Snackbar open={opens} autoHideDuration={3000} onClose={handleCloses}>
      ...
      <Box sx={style}>
           ...
           <IconButton onClick={()=>setAddLocation(false)} sx={{position:'absolute',top:'2%',right:'2%'}} >
                   <CloseIcon sx={{fontSize:'22px'}} />
               </IconButton>
   
               <Typography sx={{textAlign:'center',fontWeight:'600',mb:2}} variant="h6" >
             ...
             <label style={{fontWeight:'700'}} htmlFor="country-select-demo">Pays</label>
   ...
   />
               ...
               <label style={{fontWeight:'700'}} htmlFor="nameAdress">Adresse</label>
   ...
   />
       ...
       <Button onClick={()=>setAddLocation(false)}  variant='outlined' sx={{color:'black',bgcolor:'Window',borderRadius:'12px',fontWeight:'100',borderColor:'#9e9e9e' ,":hover":{color:'black',borderColor:'#9e9e9e',bgcolor:'Window'} }} >
           Annuler
       </Button>
         </Box>
               </Box>
