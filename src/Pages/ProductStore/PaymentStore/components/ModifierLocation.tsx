...
export const ModifierLocation = ({close,setClose}:any) => {
...
<Snackbar open={opens} autoHideDuration={3000} onClose={handleCloses}>
      ...
      >
           ...
           <IconButton onClick={()=>setClose(false)} sx={{position:'absolute',top:'2%',right:'2%'}} >
   ...
   <TextField
     ...
     value={postalCode}
       ...
       <Button onClick={()=>setClose(false)}  variant='outlined' sx={{color:'black',bgcolor:'Window',borderRadius:'12px',fontWeight:'100',borderColor:'#9e9e9e' ,":hover":{color:'black',borderColor:'#9e9e9e',bgcolor:'Window'} }} >
           Annuler
       </Button>
         </Box>
               </Box>
