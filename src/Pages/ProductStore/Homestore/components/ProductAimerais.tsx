...
export const ProductAimerais = ({product}:any) => {
  ...
  return (
    <div>
         <Box  sx={{width:'290px',height:'480px',borderRadius:'20px',mb:2,mr:2,display:'flex',flexDirection:'column',justifyContent:'center',alignItems:'center',borderColor:'#eeeeee',borderStyle:'solid' }}>
