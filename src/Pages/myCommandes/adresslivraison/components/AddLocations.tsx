...
export const AddLocations = ({setActive}:any) => {
...
<Snackbar open={opens} autoHideDuration={3000} onClose={handleCloses}>
        ...
        <IconButton onClick={()=>setActive(false)} sx={{position:'absolute',top:'2%',right:'2%'}} >
...
/>
    ...
    <Button onClick={()=>setActive(false)}  variant='outlined' sx={{color:'black',bgcolor:'Window',borderRadius:'12px',fontWeight:'100',borderColor:'#9e9e9e' ,":hover":{color:'black',borderColor:'#9e9e9e',bgcolor:'Window'} }} >
        Annuler
    </Button>
      </Box>
            </Box>
